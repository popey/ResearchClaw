...
try:
    ...
    CreateImageRequest = Any  # type: ignore[assignment,misc]
    CreateImageRequestBody = Any  # type: ignore[assignment,misc]
    CreateMessageRequest = Any  # type: ignore[assignment,misc]
    CreateMessageRequestBody = Any  # type: ignore[assignment,misc]
    CreateMessageReactionRequest = Any  # type: ignore[assignment,misc]
    CreateMessageReactionRequestBody = Any  # type: ignore[assignment,misc]
    Emoji = Any  # type: ignore[assignment,misc]
    P2ImMessageReceiveV1 = Any  # type: ignore[assignment,misc]
...
class FeishuChannel(BaseChannel):
    ...
    def _receive_id_store_path(self) -> Path:
        ...
        """
        return Path(WORKING_DIR).expanduser() / "feishu_receive_ids.json"
    ...
    async def start(self) -> None:
        if not self.enabled:
            ...
            return
        if lark is None or aiohttp is None:
            logger.warning(
                "feishu dependencies missing. Install with: "
