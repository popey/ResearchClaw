...
class LocalModelManager:
    ...
    - ResearchClaw branding and pip install instructions
    - Better error messages for research model repos
    """
    ...
    def _download_from_huggingface(
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install it with: pip install 'researchclaw[local]'",
            ) from e

        _ensure_models_dir()
        local_dir = _MODELS_DIR / _sanitize_repo_id(repo_id)
